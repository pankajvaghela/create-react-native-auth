...
var qGoogle = [
  {
    when: (answers) => (answers.integrations.includes(helpers.integrations.google.label)),
    type:"confirm-extra",
...
var qFb = [
  { 
    when: (answers) => (answers.integrations.includes(helpers.integrations.fb.label)),
    type: "input", 
    name: "fb_app_id", 
...
var qFirebase = [
  { 
    when: (answers) => (answers.integrations.includes(helpers.integrations.firebase.label)),
    type: "checkbox", 
...
var qAppCenter = [
  { 
    when: (answers) => (answers.integrations.includes(helpers.integrations.appcenter.label)),
    type: "input", 
    name: "appcenter_app_secret", 
    message:"AppCenter App Secret : ", 
    default: "appcenter_app_secret",
    validate : async function(val){
      return true;  
    },  
  },
